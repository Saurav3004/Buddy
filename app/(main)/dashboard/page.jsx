  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <PageHeader
        ...
        gray="Welcome back,"
        blue={dbUser.name?.split(" ")[0] ?? "Interviewer"}
        description={
        ...
        right={
          <div>
            ...
            <p className="font-serif text-3xl leading-none bg-linear-to-br from-blue-300 to-blue-500 bg-clip-text text-transparent text-right">
        ...
        <Tabs defaultValue="earnings" className={"p-6"}>
          <TabsList className="bg-[#0f0f11] border border-white/10 mb-8 w-full">
            ...
            <TabsTrigger value="availability" className="p-5">
              <Clock size={18} className="text-blue-400" /> Availability
            </TabsTrigger>
          </TabsList>
